...
#include "genwin.h"
int skipline(FILE*);
void readseq(struct Sequence*);
int readhdr(struct Sequence*);
int blastdb(char*);
/*---------------------------------------------------------------(defines)---*/
